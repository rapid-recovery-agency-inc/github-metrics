...
export const BLACKLISTED_CODE_USERS = new Set<string>([
    "altaciosthedev", "waqas", "fullstack900", "ghost", "dependabot[bot]", "unknown", "nicolas-toledo", "anjelysleal",
    "juansebasmarin", "yamilachan", "kaikrmen", "metalmagno", "aovallegalan", "shedeed1", "yamilachan", "snyk-bot",
    "amlingad", "brennenhamilton", "copilot-pull-request-reviewer"]);
